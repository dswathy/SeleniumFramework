...
public final class ExtentLogger {
	...
	public static void pass(String message, boolean takeScreenshot) {

		if(PropertyUtils.readProperty().get(PropertyFileConstants.PASSEDSTEPSCREENSHOT.toString()).equalsIgnoreCase("yes") &&
				takeScreenshot) {
	...
	public static void fail(String message, boolean takeScreenshot) {
		...
		if(PropertyUtils.readProperty().get(PropertyFileConstants.FAILEDSTEPSCREENSHOT.toString()).equalsIgnoreCase("yes") &&
				takeScreenshot) {
